function SetPassword() {
  ...
  <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
      <a href="#" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
          <img class=" w-20 h-20 mr-2" src="https://firebasestorage.googleapis.com/v0/b/otp-project-329ec.appspot.com/o/unnamed-removebg-preview.png?alt=media&token=4debef61-e403-4915-b54d-204a8f28be9a" alt="logo"/>
          RNSIT    
      </a>
